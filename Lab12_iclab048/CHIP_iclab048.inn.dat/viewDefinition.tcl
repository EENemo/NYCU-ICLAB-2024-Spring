...
create_library_set -name lib_min\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/SUMA_1296_BC.lib\
    ${::IMEX::libVar}/mmmc/SUMA_16384_M8_BC.lib\
    ${::IMEX::libVar}/mmmc/SUMA_400_M1_BC.lib]\
   -si\
...
create_library_set -name lib_max\
   -timing\
    ...
    ${::IMEX::libVar}/lib/typ/SUMA_1296_WC.lib\
    ${::IMEX::libVar}/lib/typ/SUMA_16384_M8_WC.lib\
    ${::IMEX::libVar}/lib/typ/SUMA_400_M1_WC.lib]\
   -si\
